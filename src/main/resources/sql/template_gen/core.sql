...
#sql("getUserFunctionTree")
	select  DISTINCT  a.order_no ,a.id,a.parent_code,a.func_name,a.link_page,a.icon,a.func_type,a.is_stop,a.spread,is_window_open 
 	from sys_function a 
...
#sql("queryRoleUserList")
	select a.id,a.user_code,a.user_name,a.org_id,a.sex,a.mobile,a.email, b.org_name
...
查询用户列表
#sql("getUserList")
	select a.id,a.user_code,a.user_name,a.sex,a.allow_login,a.tel,a.mobile,a.email,address, b.org_name
	from  sys_user a,sys_org b 
