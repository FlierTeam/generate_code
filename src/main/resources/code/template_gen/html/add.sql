...
$(this).html(element.innerText);
});
$("[lay-reqtext]").each(function (index, element) {
$(this).attr("lay-reqtext", $(this).attr("lay-reqtext"));
});
$("body").css("display", "");
